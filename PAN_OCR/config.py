...
def parse_args():
	...
	parser.add_argument('--cfg', dest="DARKNET_CFG_FILE", default="yolov3-obj.cfg", help="Darknet configuration file")
	parser.add_argument('--weights', dest="DARKNET_WEIGHTS", default="yolov3-obj_final.weights", help="Weights for Darknet")
